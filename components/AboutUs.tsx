...
export default function AboutUs() {
  return (
    <section className="min-h-dvh w-full flex flex-col md:flex-row items-center">
      ...
      <div className="relative w-full aspect-4/2 md:aspect-auto md:w-2/3 md:self-stretch">
        <Image
      ...
      <div className="w-full md:w-3/5 flex flex-col justify-center gap-8 px-10 md:px-16 lg:px-24 py-20">
        <h2 className="font-brasika text-fg leading-[1.05] text-5xl md:text-6xl lg:text-7xl">
          Nơi mỗi không gian kể một câu chuyện
        </h2>

        <div className="flex flex-col gap-5 max-w-xl text-base md:text-lg leading-relaxed text-fg/80">
          <p>
